...
@Component({
  selector: 'app-block-details-mobile',
  templateUrl: './block-details.component.mobile.html',
  styleUrls: ['./block-details.component.mobile.css']
})
export class BlockDetailsComponentMobile implements OnInit {
