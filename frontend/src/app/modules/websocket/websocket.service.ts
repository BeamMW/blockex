...
export class WebsocketService implements IWebsocketService, OnDestroy {
    ...
    * on message event
    * */
    public on<T>(initEvent: string, updateEvent: string): Observable<T> {
        if (initEvent && updateEvent) {
            return this.wsMessages$.pipe(
                filter((message: IWsMessage<T>) => message.event === initEvent || message.event === updateEvent),
