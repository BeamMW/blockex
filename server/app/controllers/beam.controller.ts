...
const blocksQueue = new Queue("update Blocks queue", "redis-service:6379");
const contractsQueue = new Queue("update Contracts queue", "redis-service:6379");
const assetsQueue = new Queue("update Assets queue", "redis-service:6379");
