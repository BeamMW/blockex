...
urlpatterns = [
    url(r'^blocks/', get_blocks),
    url(r'^range/$', get_block_range),
    url(r'^contracts/$', get_contracts),
    ...
    url(r'^get_swap_offers/$', get_swap_offers),
    path('search/<str:q>/', search),
    path('block/<str:hash>/', get_block),
    path('contract/<str:cid>/', get_contract),
